...
import {
  ...
  Search, ChevronDown, CheckCircle, Users,
} from 'lucide-react';
...
// ── Employee Search Dropdown (Portal-based to escape card overflow) ────────────
function EmployeeDropdown({ employees, selectedEmp, onSelect, loading }) {
  ...
  // Position dropdown to match trigger width & placement
      ...
      <div style={{ maxHeight: 320, overflowY: 'auto' }}>
        {filtered.length === 0 ? (
          ...
          <div key={emp.emp_id}
            ...
            onMouseEnter={e => {
              if (selectedEmp?.emp_id !== emp.emp_id)
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {/* ── Employee Selection ── */}
            {/* NOTE: overflow:visible is critical — do NOT add overflow:hidden to this card */}
